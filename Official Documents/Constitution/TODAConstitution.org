...
Tabletop games explore a wide array of themes, passions, and interests. 
From the spatial and computational constraints of physical tabletop games, simple rules allow players to construct complex theories and then devise strategies to test those theories. 
When tested, players use the collected data to revise their theories. 
Tabletop games therefore offer players the opportunity to construct theories, practice those theories, and advance those theories.

At a higher level, our tabletop organization will accommodate and promote the use of theory and practice to satisfy societal needs and values. 
Individuals of various skills and backgrounds determine societal needs and values. 
At every level, individuals develop organizational needs, and the organization provides the structure to use theory and practice to satisfy those needs.
