...
Tabletop games welcome people. Players from different backgrounds cooperate, socialize, compete, and consider new ideas. With each new game, players forge and strengthen close bonds. And with each new game, these bonds turn new players into familiar faces and can spark improvement through rivalries. However, up until now, no home exists to support and engage players' interests. TODA aims to house players' various interests and provide them with the resources to enhance, discover, and create their own experiences.



==
# Players regularly unite over tabletop games.  These interactions mean that players can improve, learn, gain insights about  gameplay, collaborate, and design and test board games.  

Whether that is ensuring a space for old friends to meet, developing a new board game with others to publish, or enabling competition and improvement.
