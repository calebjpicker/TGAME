#+TITLE: Constitution of "Tabletop Organization with Design, Data, and Application"
...
# weave metaphors and use only one. Let's try library metaphor
==
...
Tabletop games welcome people, new and old, to become players in a new situation. Within the confines of any given tabletop game, players, new and old, from different backgrounds welcome each other to collaborate, to socialize, to compete, and to consider new ideas. Each new game played offers new social interactions and dynamics that forge close bonds between players, or motivating rivalries.

==

Players regularly unite over tabletop games.  These interactions mean that players can improve themselves, can learn from and help others, can gain insights about their own and others' gameplay, can collaborate on projects, and can design and test board games.  Each new person adds a new dynamic and set of interests, but up until now, there has been no home to support and galvanize the various interests players have. Whether that is ensuring a space for old friends to meet, developing a new board game with others to publish, or enabling competition and improvement.

TODA aims to build the home that supports players' various interests and provide them with the resources to enhance, discover, and create their own experiences. Like an ensemble, TODA will have many people that contribute to a piece of music. In this house, music will be made, as TODA orchestrates people's various interests into a library of enriching experiences.
...
** Interdisciplinary and Collaborative. 
	...
	Every perspective has value through different insights. Every insight generates new value through collaboration with other perspectives.
	TODA welcomes new ways of thinking and collaboration with others.
...
#fix pillar
	...
	TODA welcomes people to collaborate with others to learn and polish the skills they need to become stronger, intelligent and compassionate.
