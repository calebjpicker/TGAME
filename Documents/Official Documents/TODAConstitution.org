...
* Article II - Purpose
  ...
  TODA will serve the following purposes:
    ...
    A) To encourage playing tabletop games;
    
    B) To encourage interdisciplinary research projects and networking;
    
    C) To encourage science literacy through data analysis;
    
    D) To use tabletop games as a familiar subject across disciplines in order to apply data analysis;
    
    E) To provide people with supplementary data analysis experience for resumes and applications.
...
***** Universal Unique ID 
      ...
      Universal Unique IDs will be required to make any and all nominations.
     
***** Procedure 
      
      A member may get nominated to an elected chair if and only if another member nominated this member and if another member seconds.
...
**** Voting Method 
     ...
     and no officer shall win an election without receiving a score from more than 11% of the active members.
